...
import { Text, FundraiserCard, ListSkeleton, TrustLevelBadge, getLifecycleConfig } from "@foreverr/ui";
...
export default function FundraiserScreen() {
  ...
  // Dynamic placeholder based on lifecycle config
  const titlePlaceholder = config.mode === "memorial"
    ? "e.g., Help with funeral expenses"
    : "e.g., Help fund the celebration";
  ...
  return (
    ...
    >
      {/* Memorial Context */}
      {memorial && (
        <View className="bg-brand-50 dark:bg-brand-900/20 rounded-2xl p-4 mb-4">
      ...
      {canFundraise && showForm && (
        <View className="mt-4">
          ...
          <TextInput
            className="border border-gray-200 dark:border-gray-700 rounded-2xl px-4 py-3 text-sm font-sans text-gray-900 dark:text-white bg-white dark:bg-gray-800 mb-4"
          ...
          <TextInput
            className="border border-gray-200 dark:border-gray-700 rounded-2xl p-4 text-sm font-sans text-gray-900 dark:text-white bg-white dark:bg-gray-800 min-h-[80px] mb-4"
          ...
          <View className="flex-row items-center border border-gray-200 dark:border-gray-700 rounded-2xl bg-white dark:bg-gray-800 mb-4">
          ...
          {/* Info */}
          <View className="flex-row bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-3 mb-6">
